...
import madam.Color;
import madam.Vehicle;

import madam.custom_exceptions.VehicleHandlingException;
...
//add a static method to check for dups (PK : ch no)
	...
	public static Vehicle validateAllInputs(String chasisNo, String vehicleClr, int basePrice, String manufactureDate,String company, List<Vehicle> showroom)
