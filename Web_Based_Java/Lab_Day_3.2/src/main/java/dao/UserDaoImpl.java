...
public class UserDaoImpl implements UserDao {
	...
	public UserDaoImpl() throws SQLException {
		...
		pst5 = connection.prepareStatement(
				"insert into users (first_name,last_name,email,password,dob,status,role) values(?,?,?,?,?,0,voter);");
	...
	public String registerNewVoter(User newVoter) throws SQLException {
		...
		if (rowCount == 1)
			return "<h3>Voter registered....</h3>";
		return "<h3>Voter reg failed!!!!!!!!!!!!!</h3>";
	}
...
//TO DO : validate user role : voter 
	...
	public String deleteUserDetails(int userId) throws SQLException {
		...
		if (rowCount == 1)
			return "<h3>Voter deleted....";
		return "<h3>Voter deletion failed!!!!!!!!!!!!!</h3>";
	...
	// Register new user ; save the info in DB
	/*
	 * public String registerNewUser(User newUser) throws SQLException {
	 * pst5.setString(1, newUser.getFirstName());
	 * 
	 * return null; }
	 */
