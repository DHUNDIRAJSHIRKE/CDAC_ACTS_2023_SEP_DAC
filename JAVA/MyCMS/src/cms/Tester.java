...
public class Tester {
	public static void main(String[] args) {
		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			Customer c1 = new Customer("Abhay", "Kushwaha", "Abhay1@cdac.in", "Password@123", 323.343, janm, Plan.GOLD);
			people.add(custCount++, c1);
			Customer c2 = new Customer("Abhijit", "Kushwaha", "Abhay2@cdac.in", "Password@123", 323.343, janm,
					Plan.SILVER);
			people.add(custCount++, c2);
			// System.out.println(c1);
			// System.out.println(c1.equals(c2));
			Customer c3 = new Customer("Vibha", "Kushwaha", "Abhay3@cdac.in", "Password@123", 323.343, janm,
					Plan.SILVER);
