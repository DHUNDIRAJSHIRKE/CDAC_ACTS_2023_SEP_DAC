			...
			case 3:
				...
				if (flag[a] == 1 && flag[b] == 1) {
					if (points[a].isEqual(points[b])) {
						...
						/*System.out.println("Distance between point at index " + a + "(" + points[a].getX() + ","
								+ points[a].getY() + ") and " + b + " (" + points[b].getX() + "," + points[b].getY()
								+ ") is " + points[b].calculateDistance(points[a])); */
						System.out.println("Distance between point at index " + a + points[a].show() + " and at index  " + b
								+ "" + points[b].show() + " is " + points[b].calculateDistance(points[a])+" units!");
					}
				}
				break;
			case 0:
