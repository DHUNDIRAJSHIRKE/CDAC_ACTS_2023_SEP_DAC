...
using Book_MVC_2.Models;

namespace Book_MVC_2.Controllers
{
    public class TblBooksController : Controller
    {
        private readonly BookApiContext _context;

        public TblBooksController(BookApiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.TblBooks != null ? 
                          ...
                          Problem("Entity set 'BookApiContext.TblBooks'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookApiContext.TblBooks'  is null.");
            }
            var tblBook = await _context.TblBooks.FindAsync(id);
            if (tblBook != null)
            {
